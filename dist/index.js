...
var script = {
  ...
  props: {
    track: {
      type: String,
      "default": "http://tamilfiles.xyz/songs/Kolamavu%20Kokila/Kalyaana%20Vayasu.mp3"
    },
    transcript: {
      type: String,
  ...
  methods: {
    setup: function setup() {
      try {
        ...
        var vttResponse = null;
        return _await(axios$1.get(_this2.transcript).then(function (response) {
          // handle success
          vttResponse = parse$1(response.data);
        })["catch"](function (error) {
          // handle error
          console.log(error);
        }).then(function () {//
        }), function () {
          _this2.subtitleLines = vttResponse;
        });
      } catch (e) {
...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('div', {
    ...
    on: {
      "timeupdate": _vm.updateTimeSprites
    }
  }, [_c('source', {
    attrs: {
      "src": _vm.track,
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.subtitleLines.length > 0,
      expression: "subtitleLines.length > 0"
    }],
    "class": ['pad', 'align--' + _vm.align, 'size--' + _vm.size]
  }, _vm._l(_vm.subtitleLines, function (line, index) {
    return _c('li', {
      key: index,
      "class": _vm.activeColor(_vm.subtitle, line),
      on: {
        "click": function click($event) {
          return _vm.seek(line);
        }
      }
    }, [_vm._v("\n      " + _vm._s(line.text) + "\n    ")]);
...
var index = {
  install: function install(Vue, options) {
    Vue.component("cockatoo-player", __vue_component__);
  }
};
